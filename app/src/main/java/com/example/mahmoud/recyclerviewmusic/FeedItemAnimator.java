package com.example.mahmoud.recyclerviewmusic;
...
/**
 * Created by Miroslaw Stanek on a02.12.2015.
 */
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
            lastAddAnimatedItem++;
            runEnterAnimation((AlbumAdapter.ViewHolder) viewHolder);
            return false;
        }
    ...
    private void runEnterAnimation(final AlbumAdapter.ViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            AlbumAdapter.ViewHolder holder = (AlbumAdapter.ViewHolder) newHolder;
            if(AlbumAdapter.ACTION_LIKE_BUTTON_CLICKED.equals(feedItemHolderInfo.updateAction))
                animateHeartButton(holder, true);
            else if(AlbumAdapter.ACTION_UNLIKE_BUTTON_CLICKED.equals(feedItemHolderInfo.updateAction))
                animateHeartButton(holder, false);
            else if (AlbumAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
                animatePhotoLike(holder);
                animateHeartButton(holder, true);
            }else if(AlbumAdapter.ACTION_UNLIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)){
                animatePhotoLike(holder);
                animateHeartButton(holder, false);
            }
        }
    ...
    private void animateHeartButton(final AlbumAdapter.ViewHolder holder, final boolean isLike) {
    ...
    private void animatePhotoLike(final AlbumAdapter.ViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(AlbumAdapter.ViewHolder holder) {
    ...
    private void resetLikeAnimationState(AlbumAdapter.ViewHolder holder) {
